...
A single-file, offline-first invoice builder for Wandermate Journeys LLP's Dev Deepawali 2026 packages, built around WanderMate's real navy brand identity and real quotation content pulled from their Canva account.
...
- **Real WanderMate branding** — the actual WanderMate logo, plus navy/white identity, wordmark, address, PAN/TAN and contact details taken from WanderMate's actual quotation template and Dev Deepawali 2026 brochure in Canva, not generic placeholders.
...
Built by connecting to the user's Canva account and reading their actual designs: "Wandermate Quotation 2321" (real quotation layout, contact info) and "Dev Deepawali 2026" (the 22-page package brochure with real pricing and inclusions), plus a few saved invoice templates for structural/visual reference. The logo (`wandermate-logo.jpg`) is the exact brand file, pulled from the user's GitHub repo. Bank/UPI payment fields were intentionally left blank (not fabricated) since real account details weren't part of the extracted content — just type directly into the Pay by UPI / Bank transfer fields on the invoice.
